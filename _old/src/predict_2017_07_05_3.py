...
def cleanup_and_generate(train, y, test, random_state=1234):
    ...
    df_all['aph_sub_h'] = df_all.ap_hi - h;
    df_all['apl_sub_h'] = df_all.ap_lo - h;
    df_all['apd_sub_h'] = df_all.ap_diff - h;

    df_all['apl_sub_w'] = df_all.ap_lo - w;
    df_all['apd_sub_w'] = df_all.ap_diff - w;
    df_all['aph_sub_w'] = df_all.ap_hi - w;
