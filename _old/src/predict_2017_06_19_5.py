...
def cleanup_and_generate(train, y, test, use_hand_labels = False):
    ...
    #idx = (df_all.r_height < 100).values * (df_all.r_weight > 170).values
    #df_all['w0'] = idx * 1
    #df_all.ix[idx, 'r_height'] += 100
    ...
    df_all['c1'] = (df_all.r_ap_hi > 250) * 1
    df_all.ix[df_all.r_ap_hi > 250, 'r_ap_hi'] /= 10

    df_all['c2'] = (df_all.r_ap_hi > 250) * 1
    df_all.ix[df_all.r_ap_hi > 250, 'r_ap_hi'] /= 10

    df_all['c3'] = (df_all.r_ap_hi < 25) * 1
    df_all.ix[df_all.r_ap_hi < 25, 'r_ap_hi'] *= 10

    df_all['c4'] = (df_all.r_ap_hi < 25) * 1
    df_all.ix[df_all.r_ap_hi < 25, 'r_ap_hi'] *= 10

    df_all['c5'] = (df_all.r_ap_lo > 250) * 1
    df_all.ix[df_all.r_ap_lo > 250, 'r_ap_lo'] /= 10

    df_all['c6'] = (df_all.r_ap_lo > 250) * 1
    df_all.ix[df_all.r_ap_lo > 250, 'r_ap_lo'] /= 10

    df_all['c7'] = (df_all.r_ap_lo < 25) * 1
    df_all.ix[df_all.r_ap_lo < 25, 'r_ap_lo'] *= 10

    df_all['c8'] = (df_all.r_ap_lo > 10000) * 1
    df_all.ix[df_all.r_ap_lo > 10000, 'r_ap_lo'] /= 100

    df_all['c9'] = df_all.r_ap_hi - df_all.r_ap_lo < 10
    df_all['csum'] = df_all.c1 + df_all.c2 + df_all.c3 + df_all.c4 + df_all.c5 + df_all.c6 + df_all.c7 + df_all.c8 + df_all.c9
